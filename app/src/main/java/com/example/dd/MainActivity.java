...
public class MainActivity extends AppCompatActivity {
                    ...
                    if (dsp != null) {
                        ...
                        if (notification != null && notification.getTime() != null && notification.getItemName() != null) {
                            if (notification.isRead() == false) {
                                ...
                                notificationButton.setBackgroundColor(getResources().getColor(R.color.purple_200)); //DON'T CHANGE THE COLORS HERE LOL
    ...
    public void onClickReg2(View v) {
        Intent i = new Intent(this, GenerateBill.class);
        startActivity(i);
    }
...
//    }
    ...
    public void onClickReg5(View v) {
        Intent i = new Intent(this, KeepNote.class);
        startActivity(i);
    }
